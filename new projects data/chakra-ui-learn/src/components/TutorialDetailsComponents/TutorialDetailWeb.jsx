...
export const TutorialDetailWeb = () => {
    ...
    useEffect(() => {
      setLoading(true)
      axios
        .get("http://13.232.130.207/learn/module/3")
        .then((res) =>{
          setModules(res.data)
          setLoading(false)
        })
      ...
      <>
        ...
        >
          ...
          <Box color={"red"} fontSize={18}>
            <Link href="/tutorials/basics-of-web-development" _hover={{ textDecoration: "none" }}>
            Basics of Web Development
            </Link>
          </Box>
        </Flex>
              ...
              >
                ...
                {e.topics.map((topic) => (
                  ...
                  >
                    ...
                    />
                    <Text marginTop={5} display="inline" color={"#746f70"} fontSize="16.3px" _hover={{ color:"red" }}>
