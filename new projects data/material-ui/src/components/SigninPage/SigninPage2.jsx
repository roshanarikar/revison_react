    ...
    <CssVarsProvider>
      <main>
        ...
        >
          ...
          <FormControl>
            <FormLabel>Enter Password for firstname@mail.com or  <NavLink className="navLink" level="body2"> change email address</NavLink></FormLabel>
      ...
      />
          ...
          <Button classes="SignupBtn">
            <NavLink className="NavLinkBtn"  to={"/signin/email/password"}>SIGN IN</NavLink>
          </Button>
          ...
          <GoogleBtn />
          <Typography
            endDecorator={<NavLink className="navLink" to="/signup">Sign in</NavLink>}
            fontSize="sm"
            sx={{ alignSelf: "center" }}
          >
