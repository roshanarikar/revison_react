...
export const SignupPage = () => {
    ...
    if (
      ...
      const checkEmail = async () => {
        ...
        const response = await fetch(
          `https://f9d7-2409-4043-70a-1a52-a8ad-e51e-8830-9ff7.in.ngrok.io/user/existuser/${formData.mobileOrEmail}`,
          {
            method: "POST",
  ...
  const handleSubmit = async (event) => {
    ...
    if (page === 1 && validate(formData.mobileOrEmail) === "email") {
      ...
      const response = await fetch(
        "https://f9d7-2409-4043-70a-1a52-a8ad-e51e-8830-9ff7.in.ngrok.io/user/signup/email/",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
      ...
      if (formData.otp === "123456") {
        const response = await fetch(
          "https://f9d7-2409-4043-70a-1a52-a8ad-e51e-8830-9ff7.in.ngrok.io/user/signup/mobile/",
          {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify(formData),
  ...
  const createOtpToEmail = async () => {
    ...
    const response = await fetch(
      `https://f9d7-2409-4043-70a-1a52-a8ad-e51e-8830-9ff7.in.ngrok.io/otp/send/${formData.mobileOrEmail}`,
      {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        mode: "no-cors",
  ...
  const verifyOtpEmail = async () => {
    const response = await fetch(
      `https://f9d7-2409-4043-70a-1a52-a8ad-e51e-8830-9ff7.in.ngrok.io/otp/verifyotp/${formData.otp}`,
      {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        mode: "no-cors",
