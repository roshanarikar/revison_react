  ...
  return (
    <Container maxW={"7xl"} py={12}>
      <SimpleGrid columns={{ base: 1, md: 2 }} spacing={10}>
        <Stack spacing={4}>
          <Heading>About Masai School</Heading>
          ...
          >
            ...
            >
              <GridItem colSpan={2} >
                <Flex>
                <div ><img width="20px" height="20px" src="https://masaischool.com/learn/_next/static/media/Heart.9d7e464b.svg" alt="" /></div>
                <Text fontSize={17} fontWeight={"bold"} paddingLeft={3} >Technical Skill Development</Text>
                </Flex>
                <Text fontSize={15} fontWeight={500} color={"grey"} paddingLeft={8} >
              ...
              <Flex>
                <div><img width="20px" height="20px" src="https://masaischool.com/learn/_next/static/media/Heart.9d7e464b.svg" alt="" /></div>
                <Text fontSize={17} fontWeight={"bold"} paddingLeft={3} >Holistic Development</Text>
                </Flex>
                <Text fontSize={15} fontWeight={500} color={"grey"} paddingLeft={8}>
              ...
              <Flex>
                <div><img width="20px" height="20px" src="https://masaischool.com/learn/_next/static/media/Heart.9d7e464b.svg" alt="" /></div>
                <Text fontSize={17} fontWeight={"bold"} paddingLeft={3} >2000+ Hiring Partners</Text>
                </Flex>
                <Text fontSize={15} fontWeight={500} color={"grey"} paddingLeft={8}>
              ...
              <GridItem colSpan={2} >
              <Flex>
                <div><img width="35px" height="35px" src="https://masaischool.com/learn/_next/static/media/Heart.9d7e464b.svg" alt="" /></div>
                <Text fontSize={17} fontWeight={"bold"} paddingLeft={3} >Masai & N.S.D.C. Announce Strategic Partnership.</Text>
                </Flex>
                <Text fontSize={15} fontWeight={500} color={"grey"} paddingLeft={8}>
