...
export const SignupPage = () => {
    ...
    if (
      ...
      const checkEmail = async () => {
        ...
        const response = await fetch(
          `https://053d-2409-4043-70a-1a52-cdbd-d015-b4e1-a788.in.ngrok.io/user/existuser/${formData.mobileOrEmail}`,
          {
            method: "POST",
  ...
  const handleSubmit = async (event) => {
    ...
    if (page === 1 && validate(formData.mobileOrEmail) === "email") {
      ...
      const response = await fetch(
        "https://053d-2409-4043-70a-1a52-cdbd-d015-b4e1-a788.in.ngrok.io/user/signup/email/",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
      ...
      if (formData.otp === "123456") {
        const response = await fetch(
          "https://053d-2409-4043-70a-1a52-cdbd-d015-b4e1-a788.in.ngrok.io/user/signup/mobile/",
          {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify(formData),
  ...
  const createOtpToEmail = async () => {
    console.log("function is called by email");
    const response = await fetch(
      `https://053d-2409-4043-70a-1a52-cdbd-d015-b4e1-a788.in.ngrok.io/otp/send/${formData.mobileOrEmail}`,
      {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        mode: "no-cors",
  ...
  const verifyOtpEmail = async () => {
    const response = await fetch(
      `https://053d-2409-4043-70a-1a52-cdbd-d015-b4e1-a788.in.ngrok.io/otp/verifyotp/${formData.otp}`,
      {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        mode: "no-cors",
    ...
    console.log("verifyOtpEmail", response);
              ...
              <form onSubmit={handleSubmit}>
                ...
                {page === 3 && (
                  <>
                    ...
                    <NavLink className="blueLink2" onClick={() => setPage(2)}>
