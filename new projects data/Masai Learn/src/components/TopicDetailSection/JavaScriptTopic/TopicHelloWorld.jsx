...
export const TopicHelloWorld = () =>{
  ...
  useEffect(() => {
    ...
    useEffect(() => {
      setLoading(true)
      axios
        .get("http://13.232.130.207/learn/topic/all?pageSize=1&pageNumber=3")
        .then((res) => {
    ...
    return(
        ...
        <Box color={"red"}>
          <NavLink to={"/tutorials/javascript-tutorial/hello-world-program-in-javascript"} _hover={{ textDecoration: "none" }}>
          Introduction
          </NavLink>
        </Box> 
        </Flex>
