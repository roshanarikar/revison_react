...
export const TutorialDetailAndroid = () => {
    ...
    useEffect(() => {
      setLoading(true)
      axios
        .get("http://13.232.130.207/learn/module/9")
        .then((res) =>{
          setModules(res.data)
          setLoading(false)
        })
      ...
      <>
        ...
        >
          ...
          <Box color={"red"} fontSize={18}>
            <Link href="tutorials/basics-of-android-app-development" _hover={{ textDecoration: "none" }}>
            Basics of Android App Development
            </Link>
          </Box>
        </Flex>
